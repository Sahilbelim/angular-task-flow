...
// //     apiMock = jasmine.createSpyObj<ApiService>('ApiService', ['logout', 'user']);
...
// //   it('should close menus on route change', () => {
// //     apiMock.user.and.returnValue(null);
// //     createComponent();
...
//     await router.navigateByUrl('/somewhere'); // 🔥 triggers router.events
